<?php
/*
Plugin Name: Atozsites MailChimp Widget
Plugin URI: https://github.com/Atozsites/widget-mailchimp
...
function Atozsites_mailchimp_widget_generic_error() {
	printf('
...
try {
	...
	add_action('admin_notices', 'Atozsites_mailchimp_widget_generic_error');
}
